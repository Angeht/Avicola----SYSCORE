...
class StoreAjusteProveedorRequest extends FormRequest
{
    public function authorize(): bool
    {
        $user = $this->user();

        return $user instanceof Usuario && $user->tienePermiso('PROVEEDORES_AJUSTAR');
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'cantidad_pollos.required' => 'Indica cuántas aves serán devueltas.',
            'cantidad_pollos.integer' => 'La cantidad de aves debe ser un número entero.',
            'peso_kg.required' => 'Indica el peso que será devuelto.',
